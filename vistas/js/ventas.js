		 ...
		 $(this).parent().parent().parent().children('.cajasMetodoPago').html(
		 	...
		 	'<div class="col-xs-6" style="padding-left:0px">'+
                ...
                '<div class="input-group">'+
                  ...
                  '<input type="number" min="0" class="form-control" id="nuevoCodigoTransaccion" placeholder="Ingrese valor a Cancelar"  required>'+
...
$(".tablas").on("click", ".btnImprimirComanda", function(){

	var codigoVenta = $(this).attr("codigoVenta");

	window.open("extensiones/tcpdf/pdf/comanda.php?codigo="+codigoVenta, "_blank"); 
