				...
				<div class="form-group row">
                  ...
                  <div class="col-xs-6" style="padding-right:0px">
                     ...
                     <div class="input-group">
                      ...
                      <select class="form-control" id="nuevoTipoPedido" name="nuevoTipoPedido" required>
                  ...
                  <div class="col-xs-6" style="padding-right:0px">
                     ...
                     <div class="input-group">
                      ...
                      <select class="form-control" id="nuevoMetodoPago" name="nuevoMetodoPago" required>
						...
						<option value="Bancolombia">Tranferencia Bancolombia</option>
						<option value="Daviplata">Tranferencia Daviplata</option>
						<option value="Nequi">Tranferencia Nequi</option>
                      </select>    
